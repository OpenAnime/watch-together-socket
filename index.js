...
io.on('connection', (socket) => {
    socket.on('login', async ({
        ...
        const {
            user,
            error
        } = await addUser(socket.id, token, room)
        ...
        if (!clients) { //make the first person in the room moderator
            user.moderator = true
        }
        ...
        socket.in(room).emit('system', {
            ...
            author: 'Mari',
            color: '#0cdd0c',
            avatar: "https://cdn.discordapp.com/attachments/859084187394637834/1102619724044587108/mari-chan.cs_human_version_9e5b74e8-aee5-4e86-915b-516370fba1f3_2.png"
        })
